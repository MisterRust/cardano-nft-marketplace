...
import { CART_ICON, DEFAULT_NFT_IMAGE, NOTIFICATION_NO_ICON, NOTIFICATION_YES_ICON, WALLET_ICON } from 'constants/image.constants';
              ...
              >
                ...
                <OffcanvasBody>
                  <NavFlex>
                    ...
                    <NavbarLink to="https://bombers.crashr.io" onClick={() => {
                      if (isMobile) setShow(false)
                    }}>
                      Bombers
                    </NavbarLink>
                    {
                      isMobile &&
                      <NavbarLink to="/my-profile" onClick={() => {
                        if (isMobile) setShow(false)
                      }}>
                        My Profile
                      </NavbarLink>
                    ...
                    <Form className="d-flex align-items-center gap-3">
                      ...
                      />
                      {
                        !myWalletAddress ?
                          ...
                          <div>
                            <img
                              src={userData && userData?.avatar ? userData?.avatar : DEFAULT_NFT_IMAGE}
                            ...
                            {/* ************ wallet dropdown ************** */}
                            {
                              showDropdown && <FlexBox
                                ...
                                bgColor='#202020' position='absolute' justifyContent='start'
                                right='165px' maxWidth='252px' height='87px' padding='18px 25px' gap="12px"
                                zIndex={1000}
