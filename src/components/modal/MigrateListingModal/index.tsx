...
interface Props {
    ...
    migrateNFT?: (utxo: string, assets: [], price: number) => Promise<void>;
}
        ...
        <StyledModal show={show} onHide={onClose} centered contentClassName="connect-success-content">
            ...
            <ModalBody>
                ...
                <CustomText
                  ...
                  display='block'
                  text={COLLECTION_DATA.hasOwnProperty(activeMigratingData.assets[0].asset.slice(0, 56)) ? COLLECTION_DATA[activeMigratingData.assets[0].asset.slice(0, 56)].name : activeMigratingData.assets[0].asset.slice(0, 56)}
                />
                {
                  COLLECTION_DATA.hasOwnProperty(activeMigratingData.assets[0].asset.slice(0, 56)) &&
                  <CustomImage
                  ...
                  />
                    ...
                    <FlexBox marginTop='56px'>
                        <CustomButton
                            ...
                            width='286px'
                            height='48px'
                            disabled={!inputPrice || inputPrice < 3 || !activeMigratingData || myWalletAddress === undefined}
                            onClick={() => {
                                // @ts-ignore
                                migrateNFT(activeMigratingData.utxo, [activeMigratingData.asset_id], parseInt(activeMigratingData.price_lovelace) / 1000000)
                            }}
                        />
                    </FlexBox>
                </FlexBox>
